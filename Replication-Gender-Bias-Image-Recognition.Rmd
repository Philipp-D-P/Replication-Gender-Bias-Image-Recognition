...
### Geschlechterstereotype in Bilderkennungssystemen – <br> Replikationsstudie eines Algorithmenaudits
...
```{r}
df_woman <- read_csv("data_replication/imgrec_women_18.01.23.csv")
df_men   <- read_csv("data_replication/imgrec_men_18.01.23.csv")
```
...
#### Image labels - get key differences
